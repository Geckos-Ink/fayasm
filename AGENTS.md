...
- `samples/cli-runner` - standalone CLI program (`fayasm_run`) that loads a module from disk and executes a selected zero-argument exported function.
