...
- Microcode compilation is only scaffolded for select bit operations; most opcodes still use switch-case dispatch and the engine does not yet precompile full functions.
