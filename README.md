...
- SIMD core opcodes are now wired (v128 load/store, shuffle/swizzle, lane ops, integer/float arithmetic, conversions). Remaining SIMD gaps are relaxed/extension opcodes beyond the core spec.
