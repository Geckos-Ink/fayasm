...
- Reference opcodes `ref.null`, `ref.is_null`, and `ref.func` now execute; `call_indirect` remains a core compatibility gap for broader WASM program coverage.
